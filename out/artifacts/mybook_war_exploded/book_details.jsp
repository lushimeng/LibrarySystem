                                            ...
                                            <form action="" method="">
                                                <table width="100%"class="cont">
                                                    <tr>
                                                        ...
                                                        <td rowspan="9" valign="top" >
                                                            <fieldset style="width: 305px; height: 410px;">
                                                             <legend>封面</legend>
                                                             <img src="${book.pic}" style="width: 300px; height: 400px;"/>
                                                            </fieldset>
                                                        </td>
                                                        <td width="2%">&nbsp;</td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td></td>
                                                        <td></td>
                                                        <td colspan="2"><input class="btn" type="button" value="返回" onclick="window.location='book.let?type=query&pageIndex=1';"></td>
                                                    </tr>
