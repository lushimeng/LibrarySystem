...
<%--                                                    <tr>--%>
<%--                                                        <td width="2%">&nbsp;</td>--%>
<%--                                                        <td width="80px">会员id：</td>--%>
<%--                                                        <td width="150px"><input class="text" type="text" name="id"  required/></td>--%>
<%--                                                        <td class="err">*用户id不存在</td>--%>
<%--                                                        <td width="2%">&nbsp;</td>--%>
<%--                                                    </tr>--%>
                                                    ...
                                                    <tr>
                                                        <td width="2%">&nbsp;</td>
                                                        <td width="80px"></td>
                                                        <td width="150px"><input onclick="return confirm('确定充值');" class="btn" type="submit" value="提交" /></td>
                                                        <td ></td>
                                                        <td width="2%">&nbsp;</td>
