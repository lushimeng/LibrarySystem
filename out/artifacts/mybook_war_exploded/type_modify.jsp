                                            ...
                                            <form action="type.let?type=modify" method="post">
                                                <table width="40%" class="cont">
                                                    <tr>
                                                        <td width="2%">&nbsp;</td>
                                                        <td width="25%">类型编号：</td>
                                                        <td width="40%"><input type="text" id="typeId" class="text"  name="txtTypeId"  value="${type.id}" disabled />  <!-- 使用disabled是展示给用户看但是用户又无法对id进行修改 -->
                                                            <input type="hidden"  class="text"  name="typeId"  value="${type.id}"  />  <!-- 使用隐藏域，方便拿去id -->
                                                        </td>
