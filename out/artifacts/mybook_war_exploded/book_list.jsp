...
<head>
    ...
    <meta http-equiv="keywords"  content = "图书 javajsp"/>
                                                ...
                                                <table width="100%"  class="cont tr_color">
                                                    ...
                                                    <c:forEach items="${books}" var="book">
                                                        <tr align="center" class="d">
                                                            <td><a href="book.let?type=details&id=${book.id}">${book.id}</a></td>
                                                            <td>${book.name}</td>
                                                            <td>${book.type.name}</td>
                                                            <td>${book.author}</td>
                                                            <td>${book.publish}</td>
                                                            <td>${book.stock}</td>
                                                            <td><img src="${book.pic}" class="cover"/></td>
                                                            <td>
                                                                <a onclick="return confirm('确认修改')"  href="book.let?type=modifypre&id=${book.id}">修改</a>&nbsp;&nbsp;
                                                                <a onclick="return confirm('确认删除')"  href="book.let?type=remove&id=${book.id}">删除</a>
                                                            </td>
                                                        </tr>
                                                    </c:forEach>
